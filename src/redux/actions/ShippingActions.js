...
export const getShippingCost = (idOrigin, idDestination, weight, callback) => async dispatch => {
  try {
    const data = {
      origin: '501',
    ...
    const res = await axios.post(API.API_RAJA_ONGKIR.concat('starter/cost'), data, {
      headers: {
