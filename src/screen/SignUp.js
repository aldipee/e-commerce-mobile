...
import { setNewUser, checkUsername, checkEmail } from '../redux/actions/AuthActions'
          ...
          <View style={localStyles.formContainer}>
            <View style={localStyles.con}>
              ...
              <Input
                ...
                errorMessage={!this.state.emailError ? false : this.state.emailError}
              />
              <Input
                ...
                errorMessage={!this.state.phoneNumberError ? false : this.state.phoneNumberError}
              />
              <Input
            ...
            <Button label={strings.SIGN_UP} buttonType="login" onPress={this.SignUp} />
